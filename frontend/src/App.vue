...
async function handleMenuAction(menu: string, item: string) {
  ...
  if (menu === "Reports") {
    const m: Record<string, string> = { "Crawl Overview": "overview", "Broken Links / Crawl Errors": "broken", "Redirect Chains": "redirects", "Duplicate Content": "duplicates", "Non-Indexable Pages": "indexability", "Missing Metadata": "missing", "Images Missing Alt Text": "images", "Structured Data": "structured", "Hreflang": "hreflang", "Directives": "directives", "Security Headers": "security", "Insecure (HTTP) URLs": "insecure", "Sitemap Coverage": "sitemap", "Slowest Pages": "pagespeed", "Orphan Pages": "orphans", "Internal PageRank": "pagerank" };
