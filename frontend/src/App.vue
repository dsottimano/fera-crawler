...
async function handleMenuAction(menu: string, item: string) {
  ...
  if (menu === "Reports") {
    const m: Record<string, string> = { "Crawl Overview": "overview", "Redirect Chains": "redirects", "Duplicate Content": "duplicates", "Non-Indexable Pages": "indexability", "Missing Metadata": "missing", "Insecure (HTTP) URLs": "insecure", "Orphan Pages": "orphans", "Internal PageRank": "pagerank" };
