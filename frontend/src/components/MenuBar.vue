...
const menus: Record<string, string[]> = {
  ...
  Reports: ["Crawl Overview", "Broken Links / Crawl Errors", "Redirect Chains", "Duplicate Content", "Non-Indexable Pages", "Missing Metadata", "Images Missing Alt Text", "Structured Data", "Hreflang", "Security Headers", "Insecure (HTTP) URLs", "Slowest Pages", "Orphan Pages", "Internal PageRank"],
