...
const menus: Record<string, string[]> = {
  ...
  Reports: ["Crawl Overview", "Broken Links / Crawl Errors", "Redirect Chains", "Duplicate Content", "Non-Indexable Pages", "Missing Metadata", "Images Missing Alt Text", "Structured Data", "Hreflang", "Directives", "Security Headers", "Insecure (HTTP) URLs", "Sitemap Coverage", "Slowest Pages", "Orphan Pages", "Internal PageRank"],
