...
const menus: Record<string, string[]> = {
  ...
  Reports: ["Crawl Overview", "Redirect Chains", "Duplicate Content", "Non-Indexable Pages", "Missing Metadata", "Structured Data", "Hreflang", "Security Headers", "Insecure (HTTP) URLs", "Slowest Pages", "Orphan Pages", "Internal PageRank"],
